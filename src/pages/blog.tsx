...
`}
        ...
        <Section
          ...
          content={` At The Dastigeeri Foundation, our mission extends beyond our regular programs, our Other Projects address unique, urgent, and impactful needs. These include medical emergencies, educational support, supporting widows, Quran distribution, other acts of Sadaqah Jariyah, and swift response to natural disasters. Our dedicated team thoroughly verifies each case, ensuring transparency and that every rupee directly reaches those in critical need cutting through red tape and getting help where it's needed most—fast. From supporting a widow to life-saving surgery, Quran distribution, and immediate disaster relief, these projects are driven by compassion, trust, and your generosity.`}
          images={[ninth, tenth]}
        />
      </div>
    </div>
